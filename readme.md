...
$rgName = 'petclinic-rg'
$location = 'eastus2'
$plan = 'petclinic-service-plan'
$app = 'petclinic-leandro'

# Create a resource group
az group create --location $location --name $rgName

# Create an app service plan of type Linux
az appservice plan create -g $rgName -n $plan --is-linux

# Create an App Service from the plan with Tomcat and JRE 8 as the runtime
az webapp create -g $rgName -p $plan -n $app --runtime "TOMCAT:10.0-java11"
```

Reference: https://docs.microsoft.com/en-us/azure/devops/pipelines/ecosystems/java-webapp?view=azure-devops&tabs=java-tomcat
